...
public class TestSparseRowMatrix {
    ...
    public void testConstructor0() {
        final SparseRowMatrix matrix = new SparseRowMatrix(2, 2);
    ...
    public void testConstructor1() {
        final SparseRowMatrix matrix = new SparseRowMatrix(2, 2, true);
    ...
    public void testCopyFromMatrix() {
        final SparseRowMatrix matrixA = new SparseRowMatrix(2, 2, true);
        final SparseRowMatrix matrixB = new SparseRowMatrix(2, 2, true);
        matrixB.fill(5);
    ...
    public void testToString() {
        final SparseRowMatrix matrix = new SparseRowMatrix(2, 2);
        assertEquals("SparseRowMatrix{rows=2, columns=2, zeroPadded=false}", matrix.toString());
    }
    ...
    @Test
    public void testAdd() {
        final SparseRowMatrix matrixA = new SparseRowMatrix(2, 2);
        matrixA.setRow(0, new float[]{1, 1});
        matrixA.setRow(1, new float[]{2, 2});

        final SparseRowMatrix matrixB = new SparseRowMatrix(2, 2);
    ...
    public void testEnlarge() {
        ...
        final SparseRowMatrix matrixB = new SparseRowMatrix(3, 3);
    ...
    public void testWriteAndRead() {
        final SparseRowMatrix matrix = new SparseRowMatrix(4, 5);
