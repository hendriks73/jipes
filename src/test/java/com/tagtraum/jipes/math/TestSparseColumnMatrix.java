...
public class TestSparseColumnMatrix {
    ...
    public void testConstructor0() {
        final SparseColumnMatrix matrix = new SparseColumnMatrix(2, 2);
    ...
    public void testConstructor1() {
        final SparseColumnMatrix matrix = new SparseColumnMatrix(2, 2, true);
    ...
    public void testCopyFromMatrix() {
        final SparseColumnMatrix matrixA = new SparseColumnMatrix(2, 2, true);
        final SparseColumnMatrix matrixB = new SparseColumnMatrix(2, 2, true);
        matrixB.fill(5);
    ...
    public void testToString() {
        final SparseColumnMatrix matrix = new SparseColumnMatrix(2, 2);
        assertEquals("SparseColumnMatrix{rows=2, columns=2, zeroPadded=false}", matrix.toString());
    }
    ...
    @Test
    public void testAdd() {
        final SparseColumnMatrix matrixA = new SparseColumnMatrix(2, 2);
        matrixA.setRow(0, new float[]{1, 1});
        matrixA.setRow(1, new float[]{2, 2});

        final SparseColumnMatrix matrixB = new SparseColumnMatrix(2, 2);
    ...
    public void testEnlarge() {
        ...
        final SparseColumnMatrix matrixB = new SparseColumnMatrix(3, 3);
    ...
    @Test
    public void testSum() {
        final SparseColumnMatrix matrix = new SparseColumnMatrix(3, 2);
    ...
    public void testWriteAndRead() {
        final SparseColumnMatrix matrix = new SparseColumnMatrix(4, 5);
    ...
    public void testIndexOutOfBoundsNegativeRow() {
        new SparseColumnMatrix(4, 5).get(-1, 0);
    }

    @Test(expected=IndexOutOfBoundsException.class)
    public void testIndexOutOfBoundsNegativeColumn() {
        new SparseColumnMatrix(4, 5).get(0, -1);
    }

    @Test(expected=IndexOutOfBoundsException.class)
    public void testIndexOutOfBoundsTooLargeRow() {
        new SparseColumnMatrix(4, 5).get(4, 0);
    }

    @Test(expected=IndexOutOfBoundsException.class)
    public void testIndexOutOfBoundsTooLargeColumn() {
        new SparseColumnMatrix(4, 5).get(0, 5);
    }
